      ...
      <form @submit.prevent="validateFormInputs">
        <div class="row">
          ...
          <div class="col-12">
            ...
            />
            <label
              style="font-size: 16px; color: #af18f9"
          ...
          <base-phone-input
            ...
            :defaultCountry="data.whatsapp_iso_code"
            :key="key"
          />
          <!-- End:: WhatsApp Input -->
          <base-input
...
export default {
  ...
  methods: {
    ...
    async getCountries() {
      try {
        let res = await this.$axios.get(`countries?is_active=1&page=0&limit=0`);
    ...
    async getAreas(country_id) {
      ...
      try {
        let res = await this.$axios({
          method: "GET",
          url: `areas?is_active=1&page=0&limit=0&country_id=${country_id}`,
        });
    ...
    async getCities(area_id) {
      ...
      try {
        let res = await this.$axios({
          method: "GET",
          url: `cities?is_active=1&page=0&limit=0&area_id=${area_id}`,
        });
    ...
    async getDistricts(city_id) {
      ...
      try {
        let res = await this.$axios({
          method: "GET",
          url: `districts?is_active=1&page=0&limit=0&city_id=${city_id}`,
        });
    ...
    async getNationalities() {
      try {
        let res = await this.$axios.get(
          `nationalities?is_active=1&page=0&limit=0`
        );
    ...
    async getHobbies() {
      try {
        let res = await this.$axios.get(`hobbies?is_active=1&page=0&limit=0`);
